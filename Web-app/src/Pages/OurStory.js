      ...
      <div className="2xl:container 2xl:mx-auto lg:py-16 lg:px-20 md:py-12 md:px-6 py-9 px-4">
        <div className="flex lg:flex-row flex-col lg:gap-8 sm:gap-10 gap-12 mt-16">
          <div className="w-full lg:w-6/12 ">
            ...
            <p className="font-normal text-base leading-6 text-gray-600 mt-12">
              It is a long established fact that a reader will be distracted by
              the readable content of a page when looking at its layout. The
              point of using Lorem Ipsum.In the first place we have granted to
              God, and by this our present charter confirmed for us and our
              heirs forever that the English Church shall be free, and shall
              have her rights entire,It is a long established fact that a reader
              will be distracted by the readable content of a page when looking
              at its layout. The point of using Lorem Ipsum.In the first place
              we have granted to God, and by this our present charter confirmed
              for us and our heirs forever that the English Church shall be
        ...
        <div className="relative mt-40">
          <div className="grid sm:grid-cols-3 grid-cols-2 sm:gap-8 gap-4">
            <div className="z-20 w-12 h-12 bg-[#E14D2A] rounded-full flex justify-center items-center">
              <svg
                width="24"
                height="24"
                viewBox="0 0 24 24"
            ...
            <svg
              ...
              xmlns="http://www.w3.org/2000/svg"
            >
              <circle cx="24" cy="24" r="24" fill="#E14D2A" />
              <path
        ...
        <div className="flex lg:flex-row flex-col lg:gap-8 sm:gap-10 gap-12 mt-32">
                ...
                <div className="w-full lg:w-6/12">
                    <img
                        className="w-full"
                        src="https://images.unsplash.com/photo-1616489950003-8e1b2e1b2b1c?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=1050&q=80"
                     alt='' />
                </div>
            </div>
      </div>
